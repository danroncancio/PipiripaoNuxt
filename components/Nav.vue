...
<template>
  <header class="fixed top-0 left-0 right-0 z-10 px-2 flex flex-col bg-base-100 font-polly text-primary xl:static">
    <nav class="navbar">
      ...
      <div class="navbar-center xl:hidden">
        <NuxtLink to="/">
          <img class="w-28" src="../assets/img/logoHeader.png" alt="logo" srcset="" />
        </NuxtLink>
      </div>
        ...
        <div class="">
          <label for="" class="btn btn-ghost btn-circle">
            <div class="w-6 rounded-full text-primary">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 553.69 519.37">
                <g data-name="Layer 2">
                  <path
          ...
          <div class="dropdown dropdown-end">
            <label tabindex="0" class="btn btn-ghost btn-circle" for="">
              <div class="indicator">
                ...
                <span class="badge indicator-item badge-sm text-base-100">{{ shoppingCart.products.length }}</span>
              </div>
            </label>
            <div tabindex="0" class="card-compact card dropdown-content mt-3 w-52 bg-base-100 shadow">
              <div class="card-body">
                <span class="text-lg">{{ shoppingCart.products.length }} Items</span>
                <span class="text-info">Subtotal: ${{ state.subtotal }}</span>
                <div>
                  <NuxtLink to="/cart"><button class="btn btn-primary btn-block">Ver Carrito</button></NuxtLink>
                </div>
              </div>
            </div>
          </div>
    ...
    <nav class="navbar hidden xl:flex">
      ...
      <div class="navbar-center flex flex-col">
        <NuxtLink to="/">
          <img class="w-56" src="../assets/img/logoHeader.png" alt="logo" srcset="" />
        </NuxtLink>
